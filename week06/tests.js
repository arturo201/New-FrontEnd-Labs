...
/*--------------------------NEW TESTS BELOW-------------------------------*/
  describe('Question 1a: Sorted array of number', () => {
...
describe('Question 1b: Manage my wallet', () => {
  ...
  it('should be able to remove money from wallet', () => {
    let myWallet = new Wallet(10)
...
describe('Question 1c: Day of the week', () => {
  ...
  it("It should return 'Err. Something went wrong.'", () => {
    expect(dayOfTheWeek(0)).to.equal()
  })
})
...
describe('Question 1d: Only Wizards should pass', () => {
  ...
  it('Should return an array of objects... objects.isAWizard should be true', () => {
