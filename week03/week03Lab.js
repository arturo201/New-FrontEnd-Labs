 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
const newArr = alphabetString.split();
console.log(newArr);
 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
let reversedArr = alphabetArray.reverse();
...
// will print 9, counting from 0 up, 9 being index 3
console.log(array1[3]);

// Finding last element of the array using slice()
 ...
 * ↓ YOUR CODE HERE ↓ */
var myTodoList = [];
myTodoList.push('Clean', 'Dishes', 'Grocery');
console.log(myTodoList);

var removeSecElem = myTodoList.splice(1,1);
console.log(myTodoList);

var yourTodoList = [];
yourTodoList.push('walk', 'run');
