...
console.log(`On July 20th 1969, ${this.firstname} ${this.lastname} was the first person to set foot on the Earth's moon`)
/*-------------------------------------------------------*/
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
let myGreeting = new Greeting('Arturo', 'Providence')
myGreeting.hello()
...
let yourBook = new Book('Outliers', 'Malcolm Gladwell');
